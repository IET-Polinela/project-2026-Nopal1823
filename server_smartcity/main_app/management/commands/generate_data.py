...
# Set Faker ke Bahasa Indonesia agar alamat & nama lebih lokal
fake = Faker('id_ID')


class Command(BaseCommand):
    help = 'Generate contextual fake reports for Metro City'
    ...
    def handle(self, *args, **kwargs):
        ...
        # Mapping Kategori dengan judul dan deskripsi yang relevan
        context_data = {
            'Jalan Rusak': {
                'titles': [
